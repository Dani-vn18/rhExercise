...
def crear_y_poblar_db():
    ...
    VALUES
    (1, '10000001', 'Carlos Pérez', '2023-01-10', '2023-07-10', 'Auxiliar de Logística', ROUND(RANDOM() * (5000000 - 1400000) + 1400000, -3), 'Proyecto A', 2),
    ...
    (5, '10000004', 'Laura Ramírez', '2023-04-25', '2023-10-25', 'Conductor de Reparto', ROUND(RANDOM() * (5000000 - 1400000) + 1400000, -3), 'Proyecto D', 2),
    ...
    (8, '10000007', 'Felipe Ruiz', '2023-07-20', '2024-01-20', 'Ingeniero de Software', ROUND(RANDOM() * (5000000 - 1400000) + 1400000, -3), 'Proyecto C', 2),
    ...
    (11, '10000010', 'Valeria Sánchez', '2023-10-05', '2024-04-05', 'Operario de Ensamblaje', ROUND(RANDOM() * (5000000 - 1400000) + 1400000, -3), 'Proyecto B', 2)
    ON CONFLICT DO NOTHING;
    """)
